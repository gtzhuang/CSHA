...
__all__ = ['resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152', 'resnet50_64x2d', 'resnet101_64x2d']
...
def conv1x1_group(in_planes, out_planes, stride=1, groups=16):
    """1x1 convolution"""
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.csha = CSHA(planes * self.expansion)        
...
def resnet50_64x2d(pretrained=False, **kwargs):
    """Constructs a ResNet-50 64x2d model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    kwargs['groups'] = 64
...
def resnet101_64x2d(pretrained=False, **kwargs):
    """Constructs a ResNet-101 64x2d model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    kwargs['groups'] = 64
