...
def build_model(model_name, args, summarywriter=None):
    if args.pretrained:
        ...
        if(args.arch=='resnet18_pasa_group_softmax'):
            ...
            model = models_lpf.resnet_csha.resnet18(num_classes=args.num_classes)
        elif(args.arch=='resnet34_csha'):
            model = models_lpf.resnet_csha.resnet34(num_classes=args.num_classes)
        elif(args.arch=='resnet50_csha'):
            model = models_lpf.resnet_csha.resnet50(num_classes=args.num_classes)
        elif(args.arch=='resnet101_csha'):
            model = models_lpf.resnet_csha.resnet101(num_classes=args.num_classes)
